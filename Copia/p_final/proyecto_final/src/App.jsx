...
import { BrowserRouter as Router, Routes, Route } from 'react-router-dom';  // Aquí está el Router
...
import AdminPanel from './componentes/Usuarios/AdminPanel';
import EditUserPage from './componentes/Usuarios/EditUserPage';
...
function App() {
  ...
  return (
    <Router> {/* BrowserRouter está aquí */}
      <AuthProvider>
        <CartProvider>
          <ProductProvider>
            <ErrorBoundary>
              <div className="App">
                ...
                <Routes>
                  ...
                  <Route path='/edit-user/:email' element={<EditUserPage/>} />
                </Routes>
